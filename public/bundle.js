		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement("input", { type: "text", placeholder: "Type city here...", ref: "location" }),
					React.createElement(
						"button",
						{ type: "submit" },
						"Get Weather "
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=670877a9c757087a78ec5c6116571249&units=imperial';
